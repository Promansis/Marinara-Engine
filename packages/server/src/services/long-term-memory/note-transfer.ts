import {
  ...
  type LtmNote,
  type LtmNoteTransferApplyResponse,
  type LtmNoteTransferConflict,
  type LtmNoteTransferMode,
  type LtmNoteTransferPreviewItem,
  type LtmNoteTransferPreviewRequest,
  type LtmNoteTransferPreviewResponse,
  type LtmScope,
  ...
  for (const item of plan.items) {
    ...
    const note = await storage.updateNote(
      ...
      { scope: nextScope },
      {
        ...
        cause: request.mode === "copy" ? "api.transfer_copy" : "api.transfer_move",
        summary: `${request.mode === "copy" ? "Copied" : "Moved"} via long-term memory transfer API`,
      },
    );
