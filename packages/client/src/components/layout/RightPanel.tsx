...
import { X, Users, BookOpen, FileText, Link, Sparkles, Settings, User, Bot, DatabaseZap } from "lucide-react";
...
const LongTermMemoryPanel = lazy(() =>
  import("../panels/LongTermMemoryPanel").then((module) => ({ default: module.LongTermMemoryPanel })),
);
...
const PANEL_CONFIG: Record<string, { title: string; icon: ReactNode; gradient?: string; gradientClass?: string }> = {
  ...
  "long-term-memory": {
    title: "Memory",
    icon: <DatabaseZap size="0.875rem" />,
...
const PANELS: Record<string, LazyExoticComponent<ComponentType>> = {
  ...
  "long-term-memory": LongTermMemoryPanel,
