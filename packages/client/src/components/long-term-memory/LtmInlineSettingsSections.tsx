  ...
  return (
    <>
      ...
      <FieldGroup
        ...
        help="Configure the connection used for memory extraction."
      >
        <div className="space-y-3">
          ...
          <label className="flex items-center gap-2">
            ...
            />
            <span className="text-xs text-[var(--foreground)]">Automatically keep low-risk changes</span>
          </label>
      ...
      {/* Section 2 — Extraction Budget */}
      <FieldGroup
        label="Extraction Budget"
        icon={<FileText size="0.875rem" className="text-[var(--primary)]" />}
        help="Control token budgets for the extraction process."
      >
        <div className="grid gap-3 sm:grid-cols-2">
          <label className="flex flex-col gap-1.5">
            <span className="text-[0.6875rem] font-medium text-[var(--muted-foreground)]">Max output tokens</span>
            <input
              type="number"
              min={512}
              max={32768}
          ...
          <label className="flex flex-col gap-1.5">
            <span className="text-[0.6875rem] font-medium text-[var(--muted-foreground)]">Source text the extractor reads</span>
            <input
              type="number"
              min={250}
              max={50000}
